...
func NewBuildCmd() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&buildOpts.mirrorPath, "mirror-path", "", "Path to pre-mirrored images from oc-mirror (skips mirroring if provided)")
...
func preRunBuild(cmd *cobra.Command, args []string) {
	envConfig = config.EnvConfig{
		...
		MirrorPath:        buildOpts.mirrorPath,
	}
