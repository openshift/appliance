...
require (
	...
	github.com/openshift/assisted-image-service v0.0.0-20241025184535-a37f68901ee1
...
require (
	...
	github.com/metal3-io/baremetal-operator v0.0.0-20220128094204-28771f489634 // indirect
